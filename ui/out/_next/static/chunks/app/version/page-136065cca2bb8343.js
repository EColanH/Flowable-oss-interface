(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[574],{7042:function(e,t,n){Promise.resolve().then(n.bind(n,2833))},4926:function(){},2833:function(e,t,n){"use strict";n.r(t);var r=n(1844),o=n(5784);n(4926);let s=()=>{let[e,t]=(0,o.useState)([]),n=async()=>{let e=await fetch("/api/actuator/info",{method:"GET",headers:{Accept:"*/*","Content-Type":"application/json"}}),n=await e.json();t(n.flowable.version)};return(0,o.useEffect)(()=>{n()},[]),(0,r.jsx)("div",{className:"container content has-text-centered",children:(0,r.jsxs)("h1",{className:"title is-5",children:["Flowable version - ",e]})})};t.default=s},9803:function(e,t,n){"use strict";/**
 * @license React
